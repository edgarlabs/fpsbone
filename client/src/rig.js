 ...
 *
 * `parts` are boxes: `[w, h, d, x, y, z]` in weapon space, with an optional 'snow' tag for
...
export const HOLDS = {
  ...
  rifle: {
    ...
    parts: [
      [0.06, 0.11, 0.44, 0, 0, -0.16],
      [0.032, 0.032, 0.3, 0, 0.005, -0.53],
      [0.05, 0.15, 0.09, 0, -0.12, -0.1],
      [0.05, 0.1, 0.16, 0, 0.005, 0.14],
    ],
  },
  sniper: {
  ...
  smg: {
    ...
    parts: [
      [0.06, 0.1, 0.3, 0, 0, -0.11],
      [0.03, 0.03, 0.12, 0, 0.005, -0.32],
      [0.045, 0.17, 0.07, 0, -0.13, -0.06],
      [0.05, 0.08, 0.1, 0, 0.005, 0.09],
    ],
  },
  lmg: {
  ...
  rifle_havoc: {
    ...
    parts: [
      [0.078, 0.12, 0.48, 0, 0, -0.18], [0.04, 0.04, 0.34, 0, 0.01, -0.58],
      [0.06, 0.17, 0.1, 0, -0.13, -0.1], [0.065, 0.11, 0.22, 0, 0, 0.18],
    ],
  },
  rifle_falcon: {
    grip: [0.145, -0.18, -0.18], support: [0.075, -0.17, -0.36],
    parts: [
      [0.06, 0.095, 0.36, 0, 0, -0.13], [0.03, 0.03, 0.24, 0, 0.008, -0.43],
      [0.046, 0.135, 0.07, 0, -0.105, -0.06], [0.04, 0.075, 0.2, 0, 0, 0.15],
    ],
  },
  smg_kite: {
    grip: [0.145, -0.18, -0.18], support: [0.085, -0.17, -0.29],
    parts: [
      [0.052, 0.085, 0.24, 0, 0, -0.08], [0.026, 0.026, 0.11, 0, 0.005, -0.25],
      [0.04, 0.15, 0.06, 0, -0.115, -0.035], [0.025, 0.04, 0.18, 0, 0, 0.12],
    ],
  },
  smg_banshee: {
    grip: [0.15, -0.185, -0.17], support: [0.08, -0.175, -0.33],
    parts: [
      [0.072, 0.105, 0.34, 0, 0, -0.12], [0.034, 0.034, 0.16, 0, 0.008, -0.36],
      [0.052, 0.13, 0.075, 0, -0.1, -0.07], [0.05, 0.085, 0.13, 0, 0, 0.13],
    ],
  },
  pistol_wisp: {
    grip: [0.088, -0.155, -0.43], support: [0.043, -0.175, -0.45],
    parts: [[0.04, 0.062, 0.17, 0, 0.02, -0.06], [0.04, 0.1, 0.052, 0, -0.055, 0.02]],
  },
  pistol_rook: {
    grip: [0.095, -0.16, -0.4], support: [0.048, -0.18, -0.42],
    parts: [[0.062, 0.09, 0.26, 0, 0.025, -0.09], [0.056, 0.135, 0.075, 0, -0.08, 0.025]],
  },
  lmg_atlas: {
    grip: [0.155, -0.19, -0.17], support: [0.08, -0.18, -0.41],
    parts: [
      [0.078, 0.115, 0.46, 0, 0, -0.17], [0.038, 0.038, 0.34, 0, 0.006, -0.57],
      [0.08, 0.15, 0.17, 0, -0.12, -0.11], [0.056, 0.1, 0.2, 0, 0, 0.18],
    ],
  },
  lmg_colossus: {
    grip: [0.16, -0.195, -0.16], support: [0.07, -0.18, -0.42],
    parts: [
      [0.095, 0.145, 0.58, 0, 0, -0.2], [0.046, 0.046, 0.46, 0, 0.008, -0.7],
      [0.12, 0.19, 0.25, 0, -0.145, -0.13], [0.07, 0.12, 0.24, 0, 0, 0.22],
    ],
  },
  knife_karambit: {
    grip: [0.19, -0.13, -0.3], support: null,
    parts: [[0.022, 0.09, 0.25, 0, 0.06, -0.16], [0.046, 0.055, 0.15, 0, -0.005, 0.03], [0.07, 0.07, 0.025, 0, -0.005, 0.12]],
  },
  knife_tanto: {
    grip: [0.19, -0.13, -0.3], support: null,
  ...
  knife_kukri: {
    ...
    parts: [[0.032, 0.13, 0.34, 0, 0.075, -0.25], [0.08, 0.03, 0.04, 0, 0.01, -0.045], [0.052, 0.065, 0.18, 0, -0.006, 0.065]],
  },
...
export function deadGunZ(hold) {
  ...
  if (z === undefined) {
    ...
    for (const [w, h, d, cx, cy, cz] of hold.parts) {
      for (const sx of [-1, 1]) {
        for (const sy of [-1, 1]) {
          for (const sz of [-1, 1]) {
            const c = rotateXYZ(
